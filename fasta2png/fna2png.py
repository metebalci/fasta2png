...
def main():
    ...
    parser.add_argument('--input', required=True, help='input (fasta/fna) file name')
    parser.add_argument('--output', required=True, help='output (rgba png) file name')
    parser.add_argument('--pixel-size', type=int, default=1, help='size of a (nucleotid) base in final png in pixels, default is 1')
